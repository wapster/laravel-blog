          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              {{Form::select('tags[]',
                $tags,
                null,
                ['class' => 'form-control select2', 'multiple'=>'multiple', 'placeholder' => 'Выберите теги...']
              )}}
            </div>
            <!-- Date -->
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <input type="text" class="form-control pull-right" id="datepicker" name="date" value="{{old('date')}}" placeholder="dd/mm/yy">
              </div>
              <!-- /.input group -->
            </div>
